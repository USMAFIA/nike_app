...
class _AccountSetupImgNameState extends State<AccountSetupImgName> {
  ...
  Widget buildSizeButton(double size) {
          ...
          children: [
            Row(
              children: [
                ...
                Expanded(child: AccountSetupHeading(text: widget.heading),),
                Container(
                  width: 25,
                  height: 25,
                  ...
                  child: Center(
                      child: widget.isSelected ? const Icon(Icons.done,size: 15,) : Container()),
                ),
              ],
            ),
